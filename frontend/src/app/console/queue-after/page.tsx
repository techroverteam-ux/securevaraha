...
export default function ConsoleQueueAfter() {
  const toast = useToastContext();
  const router = useRouter();
  const [patients, setPatients] = useState<ConsolePatientAfter[]>([]);
  ...
  const fetchPatients = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/console/queue-after?${params}`);
      if (response.ok) {
        ...
        console.error('Console queue-after API error:', errorData);
    ...
    <div className="p-6 space-y-6">
      <div className="bg-gradient-to-r from-sky-500 to-sky-600 text-white p-6 rounded-xl shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Patient Queue - After</h1>
            <p className="text-sky-100">Console management for post-examination patients</p>
          </div>
          <button
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Patient Queue After</h2>
                  ...
                  <tr key={patient.p_id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-black">
                        {patient.pre} {patient.patient_name}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
