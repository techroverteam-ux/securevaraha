...
export default function HospitalManagement() {
  ...
  return (
    <SuperAdminLayout 
      ...
      subtitle="Manage hospitals and their information"
    >
                ...
                {paginatedHospitals.map((hospital, index) => (
                  <tr key={hospital.h_id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{hospital.h_name}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex space-x-2">
                        <button onClick={() => handleEdit(hospital)} className="inline-flex items-center px-3 py-1 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all duration-200 text-xs font-medium shadow-md">
                          <Edit className="h-3 w-3 mr-1" />
                          Edit
                        </button>
                        <button onClick={() => handleDelete(hospital)} className="inline-flex items-center px-3 py-1 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all duration-200 text-xs font-medium shadow-md">
