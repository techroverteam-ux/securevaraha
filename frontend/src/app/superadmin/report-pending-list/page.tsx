...
export default function PendingReports() {
  ...
  const formatDate = (dateString: string) => {
    if (!dateString || dateString === '00-00-0000' || dateString === '0000-00-00') return '';
  ...
  const handleDownloadExcel = () => {
      ...
      <html>
        ...
        <body>
          <table>
            ...
            <tr><th colspan="10" class="header">PENDING REPORTS LIST</th></tr>
            <thead>
              <tr>
    ...
    a.download = `Pending-Reports-List-${todayFormatted}.xls`;
    a.click();
    ...
    <div className="p-6 space-y-6">
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between">
          ...
          <Button onClick={fetchPendingReports} disabled={loading}>
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {loading ? (
                ...
                <tr>
                  <td colSpan={10} className="px-3 py-2 text-center text-gray-500">No pending reports found</td>
                </tr>
              ) : (
                  ...
                  <tr key={report.p_id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 whitespace-nowrap text-sm text-center">
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        report.ct_scan === 'yes' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                      }`}>
                        {report.ct_scan}
                      </span>
                    </td>
                    ...
                    <td className="px-3 py-2 whitespace-nowrap text-sm text-center">
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        report.xray === 'yes' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                      }`}>
                        {report.xray}
                      </span>
                    </td>
